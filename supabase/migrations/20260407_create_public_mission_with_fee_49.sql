-- City pin creation: deduct Scout Stake 49 EGP (integer) from creator wallet, insert public mission in funding.
-- Aligns with constants.SCOUT_STAKE_FEE_EGP and UI copy.
...
begin
  ...
  v_goal := floor(coalesce(p_amount_target, 0))::integer;
  if v_goal < 50 then
